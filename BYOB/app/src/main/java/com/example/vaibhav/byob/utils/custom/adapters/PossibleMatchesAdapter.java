...
public class PossibleMatchesAdapter extends ArrayAdapter<String> {
    ...
    public PossibleMatchesAdapter(Activity context, List<String> date, List<String> offerId, List<String> address) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.possible_matches_adapter_custom_listview, null, true);
